...
export default function Footer() {
  return (
    <footer className="flex flex-col p-6 sm:p-4 bg-primary gap-4 z-40">
      <div className="flex flex-col sm:flex-row-reverse sm:justify-end gap-10 sm:gap-20">
        <div className="flex flex-col sm:flex-row sm:w-1/2 sm:mt-4 gap-6 sm:gap-16 lg:w-1/3 lg:items-center">
