...
const MissionSection: FC = () => {
  return (
    <section className="relative lg:w-full">
      <div className="w-full flex flex-col items-center sm:my-8 py-8 sm:p-10 bg-primary drop-shadow-md">
        <h2 className="text-center text-background">
          Our Mission
        </h2>

        <p className="mt-4 txt-md text-background text-center w-full sm:w-2/3 2xl:w-1/2">
